...
import { Text, TextInput, Button, Pressable, Keyboard, TouchableOpacity } from 'react-native';
...
export const AddUser = ({ navigation }) => {
  ...
  return (
    ...
    <Pressable style={style.container} onPress={Keyboard.dismiss} >
      ...
      <TouchableOpacity style={style.cadastrarnovousuario}>
      <Text style={style.cadastronovo} onPress={() => navigation.navigate('')}>Cadastrar novo usuário</Text>
    </TouchableOpacity>
    </Pressable>
  )
};
